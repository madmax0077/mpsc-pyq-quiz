          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
              ...
              <a
                ...
                className="text-base font-medium text-indigo-600 hover:text-indigo-700 hover:underline"
              >
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="mb-2 text-sm font-semibold text-slate-700">What can you contact us about?</h3>
