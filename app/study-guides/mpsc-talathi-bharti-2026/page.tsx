  ...
  return (
    <>
      ...
      <p>
        ...
        पदाचा मान-सन्मान फक्त उत्तरपत्रिका भरून मिळत नाही.
      </p>
      ...
      <ul>
        <li>नकारात्मक गुणांकन असल्यास अचूकता महत्त्वाची; आंधळे प्रयत्न नव्हे</li>
      ...
      <p>
        <Link href="/study-guides/mpsc-negative-marking">नकारात्मक गुणांकन</Link> मार्गदर्शक एकदा
      ...
      <ul>
        ...
        <li>जमीन महसूल शब्दकोश सुरु करा</li>
