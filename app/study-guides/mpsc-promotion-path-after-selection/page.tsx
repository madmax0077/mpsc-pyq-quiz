...
function MarathiBody() {
  return (
    <>
      <h2>एमपीएससी निवडीनंतरची पदोन्नती वाटचाल — खरे करिअर मार्ग</h2>
      <p className="!mt-2 !text-sm !text-slate-500 dark:!text-slate-400">
        अद्यतन: ऑगस्ट २०२६ · अंदाजे वाचन वेळ: १० मिनिटे
      </p>

      <p>
        निवड दार आहे; पदोन्नती लांब रस्ता आहे. PSI, STI, ASO चे सुरुवातीचे पगार जवळपास समान
        परिसरात असतात. पुढची १५–२५ वर्षे{" "}
        <strong>विभागीय पदोन्नती मार्ग आणि सेवेत देण्यात येणारी उच्च परीक्षा</strong> ठरवतात
        तुम्ही किती वर जाल. हे मार्गदर्शक वास्तववादी पदोन्नती मार्ग दाखवते — “८ वर्षांत
      ...
      <StudyGuideTable
        headers={["प्रवेश पद", "सुरुवातीचा मार्ग", "दीर्घ क्षितिज"]}
        rows={[
          ["PSI", "PSI → पोलीस निरीक्षक (आणि पुढील पोलीस श्रेणी)", "वरिष्ठ पोलीस श्रेणी; समांतर उच्च परीक्षा"],
          ["STI", "राज्य कर निरीक्षक → उच्च कर प्रशासन श्रेणी", "राज्य कर / GST यंत्रणेतील मार्ग"],
          ["ASO", "सहाय्यक विभाग अधिकारी → विभाग अधिकारी / उच्च सचिवालय", "मंत्रालयीन प्रशासकीय मार्ग"],
      ...
      <h3>२. तलाठी / महसूल पदोन्नती मार्ग — सर्वाधिक स्पष्ट सार्वजनिक मार्ग</h3>
      <ul>
        <li>
      ...
      <h3>४. कायदेशीर दृष्टीने सर्वात मोठा मार्ग</h3>
      <p>
        अनेक गट-क / गट-ब अधिकाऱ्यांसाठी सर्वात मोठा मार्ग म्हणजे{" "}
        <strong>सेवेत असताना उच्च एमपीएससी परीक्षा उत्तीर्ण करणे</strong> (उदा. राज्यसेवा /
