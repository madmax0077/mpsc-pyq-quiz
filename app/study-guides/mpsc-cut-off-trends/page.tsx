  ...
  return (
    <>
      ...
      <p>
        ...
        आणि गट-क मेन्स कट ऑफ कसे वाचायचे ते सांगते — मग त्याचा उपयोग पुढच्या मॉकसाठी लक्ष्य
        ठरवण्यासाठी करा.
      </p>
      ...
      <ul>
        ...
        <li>
          पूर्वपरीक्षा फक्त मेन्ससाठी पात्र करते. अंतिम निवड मेन्स गुणांवर (आणि PSI साठी लागू
          असल्यास मुलाखत गुणांवर) अवलंबून असते.
        </li>
      </ul>
      ...
      <p>
        गट-क मेन्स कट ऑफ अनेकदा पूर्वपरीक्षेपेक्षा <strong>खूप मोठ्या स्केलवर</strong> प्रकाशित
        होतात (शेकडो गुण). २०२४ Clerk-Typist मेन्ससाठी प्रसिद्ध झालेल्या उदाहरणात Open General{" "}
        <strong>२८०</strong>, Open Female <strong>२६०</strong>. हे “१०० पैकी पूर्वपरीक्षा” आकडे
        नाहीत — गट-ब पूर्व कट ऑफशी थेट तुलना करणे चुकीचे आहे.
      </p>
