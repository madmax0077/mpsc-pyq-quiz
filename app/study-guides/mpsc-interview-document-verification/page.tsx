...
function MarathiBody() {
  return (
    <>
      ...
      <p>
        अनेक उमेदवार पूर्वपरीक्षा उत्तम देतात आणि नंतर जात-वैधता प्रमाणपत्राच्या अभावामुळे
        किंवा अधिवास प्रमाणपत्रातील नावाच्या फरकामुळे महिने वाया घालवतात. हे मार्गदर्शक सांगते की{" "}
