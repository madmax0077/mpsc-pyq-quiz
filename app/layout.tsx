...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // New: newspapers topic pack
    "वर्तमानपत्र संस्थापक", "newspapers founders India", "Indian newspapers history MPSC",
    "newspapers MCQ Marathi", "MPSC newspapers list", "Rajyaseva newspapers",
    "RTO AMVI newspapers", "Bal Shastri Jambhekar Darpan", "Tilak Kesari Maratha",
    "Raja Ram Mohan Roy Sambad Kaumudi", "Gandhi Young India Harijan",
    "Maulana Azad Al Hilal", "Ghosh brothers Amrit Bazar Patrika",
  ],
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": `${SITE_URL}/newspapers#resource`,
        url: `${SITE_URL}/newspapers`,
        name: "वृत्तपत्र — संस्थापक, संपादक व 100 MCQ (Newspapers Topic Pack)",
        isPartOf: { "@id": `${SITE_URL}/#website` },
        inLanguage: ["mr", "en"],
        learningResourceType: ["Reference table", "Quiz"],
        educationalUse: ["Self-study", "Revision", "Test preparation"],
        audience: {
          "@type": "EducationalAudience",
          educationalRole: "MPSC / Rajyaseva / RTO AMVI / UPSC aspirant",
        },
        about: [
          { "@type": "Thing", name: "Indian newspapers history" },
          { "@type": "Thing", name: "Newspaper founders and editors" },
          { "@type": "Thing", name: "Modern Indian History — press" },
        ],
        author: { "@id": `${SITE_URL}/#org` },
        publisher: { "@id": `${SITE_URL}/#org` },
        description:
          "Curated reference of 70+ Indian newspapers and 50+ founders/editors organised in 6 historical groups, paired with 100 unique multiple-choice questions and answers. Designed for last-week revision before MPSC, Rajyaseva, RTO AMVI and UPSC prelims.",
        hasPart: {
          "@type": "Quiz",
          name: "Indian Newspapers — 100 MCQ",
          numberOfQuestions: 100,
          inLanguage: "mr",
          assesses: "Founders and editors of Indian newspapers (1780–1947)",
        },
      },
      {
        "@type": "FAQPage",
