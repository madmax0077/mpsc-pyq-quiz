...
export default function SearchBar({ allQuestions }: Props) {
              ...
              {results.map((r) => {
                ...
                return (
                  <button
                    ...
                    className="w-full rounded-lg px-3 py-2.5 text-left hover:bg-slate-50 transition-colors dark:hover:bg-slate-700/50"
                  >
                    ...
                    {isExpanded && (
                      <div className="mt-2 rounded-lg bg-slate-100 p-3 text-xs dark:bg-slate-900" onClick={(e) => e.stopPropagation()}>
