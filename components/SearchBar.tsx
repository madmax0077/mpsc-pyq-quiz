...
export default function SearchBar({ allQuestions, onSelect }: Props) {
          ...
          {query.length < 2 ? (
            ...
            <div className="space-y-1">
              {results.map((r) => {
                ...
                const canNavigate = !!onSelect && !!r.question.category;
                return (
                  <div key={r.question.id} className="rounded-lg hover:bg-slate-50 transition-colors dark:hover:bg-slate-700/50">
                    <button
                    ...
                    {isExpanded && (
                      <div className="px-3 pb-2.5">
                        <div className="rounded-lg bg-slate-100 p-3 text-xs dark:bg-slate-900">
                        ...
                        {canNavigate && (
                          ...
                          >
                            ...
                            Go to Question in {r.question.category}
                          </button>
                        )}
                      </div>
                    )}
