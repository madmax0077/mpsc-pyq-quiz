...
function QuestionCard({
  ...
  return (
    <div>
      <p className="text-[15px] font-semibold leading-7 text-slate-900 dark:text-slate-100">
        {question.text}
      </p>
        ...
        {OPTION_KEYS.map((k) => {
          ...
          return (
            ...
            >
              ...
              <span className="leading-6">{question.options[k]}</span>
            </button>
          );
        })}
      </div>
          ...
          {lesson.concepts.map((c, i) => (
            ...
            >
              <h3 className="flex items-center gap-2 text-base font-bold text-slate-900 dark:text-slate-100">
                <span
                  className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs font-bold ${accent.chip}`}
                >
                  {i + 1}
                </span>
                {c.heading}
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-4 flex items-center justify-between gap-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">{q.topicName}</h2>
              {q.difficulty && (
                <span
                  className={
          ...
          <button
            ...
            className="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-semibold text-slate-600 transition-colors hover:border-rose-300 hover:text-rose-600 dark:border-slate-600 dark:text-slate-300"
          >
            End practice
          </button>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between gap-3">
          <button
            ...
            disabled={current === 1}
            className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 transition-colors hover:border-indigo-300 disabled:cursor-not-allowed disabled:opacity-40 dark:border-slate-600 dark:text-slate-200"
          >
            Previous
          </button>
          ...
          {!checked ? (
            <button
              ...
              disabled={!selected}
              className="rounded-xl bg-indigo-600 px-6 py-2 text-sm font-bold text-white transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Check answer
            </button>
          ) : (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="mt-5 flex items-center justify-between gap-3">
            <button
              ...
              disabled={current === 1}
              className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 transition-colors disabled:cursor-not-allowed disabled:opacity-40 dark:border-slate-600 dark:text-slate-200"
            >
              Previous
            </button>
            <button
            ...
            <button
              ...
              className="rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Next
            </button>
          </div>
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-700">
              {result.byTopic.map((row) => (
                <div key={row.topicId} className="flex items-center justify-between gap-3 px-5 py-2.5">
