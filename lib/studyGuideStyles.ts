...
export const STUDY_GUIDE_PROSE_CLASS = [
  ...
  // Headings
  "prose-headings:scroll-mt-24 prose-headings:font-bold prose-headings:text-slate-800 dark:prose-headings:text-slate-100",
  "prose-h2:mb-3 prose-h2:mt-0 prose-h2:text-[1.5rem] prose-h2:leading-snug sm:prose-h2:text-[1.65rem]",
  ...
  // Body
  "prose-p:my-4 prose-p:leading-[1.8] prose-p:text-[0.975rem] sm:prose-p:text-[1.02rem]",
  ...
  "prose-a:font-medium prose-a:text-indigo-600 prose-a:no-underline hover:prose-a:underline dark:prose-a:text-indigo-400",
].join(" ");
